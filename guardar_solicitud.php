...
VALUES ($_POST[opsector]','$_POST[clasificacion]','$_POST[rsocial]','$_POST[destablecimiento]','$_POST[col]','$_POST[giro]',
'$_POST[opecivil]','$_POST[nestudios]','$_POST[ntelefono]','$_POST[email]','$_POST[optempresa]','$_POST[empleos]','$_POST[inversion]',
'$_POST[superficie]','$_POST[asunto]','$_POST[fecha]','$_POST[fnacimiento]','$_POST[fapertura]')";
mysql_query($sql);
session_start();
