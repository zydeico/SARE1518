...
$resultado = mysql_query("SELECT * FROM tblsolicitud where folio='$folio' or estatus='$estatus'");
...
?>
	  ...
	  <tr class="<?php echo $estilo ?>">
	    ...
	    <td>
		<a class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal<?php echo $row['folio']; ?>"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span></a>
...
<div class="row">  
	...
	<div class="col-md-6">
		<div class="form-group">
    		<label for="c">CLACIFICACI�N</label>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group">
    		<label for="d">DIRECCI�N ESTABLECIMIENTO</label>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group">
    		<label for="fn">Revisi�n de Predial</label>
...
<div class="row">
	<div class="col-md-8">
		<div class="form-group">
    		<label for="fn">Copia de Identidicaci�n</label>
	...
	<div class="col-md-4">
		<div class="form-group">
        <span class="glyphicon glyphicon-arrow-down"></span>
        	<label for="fn">Identificaci�n</label>
