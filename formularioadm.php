...
<!-- Finish Header -->
<!-- Body -->
<form method="post" action="guardar_solicitudadm.php" onsubmit="return checkCheckBox(this)">
...
<!-- Finish Modal -->
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="input-group">
          <span class="input-group-addon" scr="" id="sizing-addon2"><a href="pdfs/FUA.pdf" target="_blank"><span class="glyphicon glyphicon-exclamation-sign orange"></span> Formato Unico de Apertura</span></a> 
        </div>
      </div>
      </div>
    ...
    <!--<a href="https://twitter.com/DesEconomicoSa" target="_blank"><img style="float:right" width="35" height="35" class="img-responsive" src="img/twitter.jpg"></a>-->
