...
<h3 align="center" style="color:color:#042944;">DIRECCI�N GENERAL DE DESARROLLO ECONMICO</h3>
<p align="center" style="font-size:20px;">SARE</p><br />
<p align="left" style="font-size:15px;">* Dependiendo de tu tramite necesitas subir la documentaci�n correspondiente (persona f�sica o moral).</p><br />
            ...
            if($_FILES["archivo"]["type"][$i]=="application/pdf" )
            {
                ...
                if(file_exists($carpetaDestino) || @mkdir($carpetaDestino))
                {
                    ...
                    if(@move_uploaded_file($origen, $destino))
                    {
						...
						print('<META HTTP-EQUIV="Refresh" CONTENT=0;URL=documentosadm.php>');
    ...
    <div class="col-md-6">
     <br />
		<div class="input-group">
			<div  style="background:rgba(231,231,231,1.00); padding:8px;border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;">
			<p></p>
    		<span class="input-group" id="sizing-addon2" style="font-size:16px; font-weight:bold;"> Copia de Identificaci�n</span>
	 		 <input type="file"  class="form-control-addon" placeholder="" aria-describedby="sizing-addon2" name="identificacion[]" multiple><br />
      		<button class="btn btn-sm btn-primary" type="submit" name="enviar" value="Enviar">Subir Identificaci�n</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="col-md-6">
	<div class="input-group">
		<div  style="background:rgba(231,231,231,1.00); padding:8px;border-radius: 10px 10px 10px 10px;-moz-border-radius: 10px 10px 10px 10px;-webkit-border-radius: 10px 10px 10px 10px;">
		<p></p>
        <span class="input-group" id="sizing-addon2"  style="font-size:16px; font-weight:bold;"> Revisi�n de Predial</span>
...
<form action="generarfolioadm.php" method="post">
